...
var customtablefields = {
  'icon': {
    'draw': function(t,row,child_row,field) {
      if (t.data[row][field] == true) return "<i class='"+t.fields[field].trueicon+"' type='input' style='cursor:pointer' title="+((typeof(t.fields[field].tooltip) == "undefined")?"":'"'+t.fields[field].tooltip+'"')+"></i>";
      if (t.data[row][field] == false) return "<i class='"+t.fields[field].falseicon+"' type='input' style='cursor:pointer' title="+((typeof(t.fields[field].tooltip) == "undefined")?"":'"'+t.fields[field].tooltip+'"')+"></i>";
    },
  ...
  'iconlink': {
    'draw': function (t,row,child_row,field) {
      ...
      return "<a href='"+t.fields[field].link+t.data[row]['id']+"' ><i class='"+icon+"' title="+((typeof(t.fields[field].tooltip) == "undefined")?"":'"'+t.fields[field].tooltip+'"')+"></i></a>" 
    }
  },

  'iconbasic': {
    'draw': function(t,row,child_row,field) {
      return "<i class='"+t.fields[field].icon+"' type='icon' row='"+row+"' child_row='"+child_row+"' style='cursor:pointer' title="+((typeof(t.fields[field].tooltip) == "undefined")?"":'"'+t.fields[field].tooltip+'"')+"></i>";
    }
  },

  'hinteditable': {
    'draw': function (t,row,child_row,field) { return "<i title='"+t.data[row][field]+"'>…</i>…";},
  ...
  'iconconfig': {
    'draw': function(t,row,child_row,field) {
      return t.data[row]['#NO_CONFIG#'] ? "" : "<i class='"+t.fields[field].icon+"' type='icon' row='"+row+"' child_row='"+child_row+"' style='cursor:pointer' title="+((typeof(t.fields[field].tooltip) == "undefined")?"":'"'+t.fields[field].tooltip+'"')+"></i>";
    }
  },
