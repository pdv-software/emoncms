...
var table = {
  ...
  'fieldtypes': {
    ...
    'delete': {
      'draw': function (t,row,child_row,field) { return t.data[row]['#READ_ONLY#'] ? "" : "<a type='delete' row='"+row+"' child_row='"+child_row+"' uid='"+t.data[row]['id']+"' ><i class='icon-trash' style='cursor:pointer' title="+((typeof(t.fields[field].tooltip) == "undefined")?"":'"'+t.fields[field].tooltip+'"')+"></i></a>"; }
    },

    'edit': {
      'draw': function (t,row,child_row,field) { return t.data[row]['#READ_ONLY#'] ? "" : "<a type='edit' row='"+row+"' child_row='"+child_row+"' uid='"+t.data[row]['id']+"' mode='edit'><i class='icon-pencil' style='cursor:pointer' title="+((typeof(t.fields[field].tooltip) == "undefined")?"":'"'+t.fields[field].tooltip+'"')+"></i></a>"; },
    },
