...
class Schedule_ProcessList
{
    ...
    public function process_list()
    {
        ...
        $list[] = array(_("If !schedule, ZERO"), ProcessArg::SCHEDULEID, "if_not_schedule_zero", 0, DataType::UNDEFINED, "Schedule", 'desc'=>"<p>"._("Validates if time is NOT in range of schedule. If NOT in schedule, value is ZEROed. "._("Value is passed for further processing by the next processor in the processing list.")."</p><p>"._("You can use this to get a feed for each of the multi-rate tariff rate your provider gives. Add the 'Reset to Original' process before this process to log the input value to a different feed for each schedule on the same processing list")."</p>"));
        $list[] = array(_("If !schedule, NULL"), ProcessArg::SCHEDULEID, "if_not_schedule_null", 0, DataType::UNDEFINED, "Schedule", 'desc'=>"<p>"._("Validates if time is NOT in range of schedule. If NOT in schedule, value is NULLed. "._("Value is passed for further processing by the next processor in the processing list.")."</p><p>"._("You can use this to get a feed for each of the multi-rate tariff rate your provider gives. Add the 'Reset to Original' process before this process to log the input value to a different feed for each schedule on the same processing list")."</p>"));
        $list[] = array(_("If schedule, ZERO"),  ProcessArg::SCHEDULEID, "if_schedule_zero",     0, DataType::UNDEFINED, "Schedule", 'desc'=>"<p>"._("Validates if time is in range of schedule. If in schedule, value is ZEROed. "._("Value is passed for further processing by the next processor in the processing list.")."</p><p>"._("You can use this to get a feed for each of the multi-rate tariff rate your provider gives. Add the 'Reset to Original' process before this process to log the input value to a different feed for each schedule on the same processing list")."</p>"));
        $list[] = array(_("If schedule, NULL"),  ProcessArg::SCHEDULEID, "if_schedule_null",     0, DataType::UNDEFINED, "Schedule", 'desc'=>"<p>"._("Validates if time is in range of schedule. If in schedule, value is NULLed. "._("Value is passed for further processing by the next processor in the processing list.")."</p><p>"._("You can use this to get a feed for each of the multi-rate tariff rate your provider gives. Add the 'Reset to Original' process before this process to log the input value to a different feed for each schedule on the same processing list")."</p>"));
        return $list;
    }
